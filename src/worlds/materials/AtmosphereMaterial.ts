...
const atmosphereShader = {
  uniforms: {
    lightDirection: { value: new Vector3(1.0, 1.0, 0.0).normalize() }, // Sunlight direction
    atmosphereColor: { value: new Vector3(0.3, 0.6, 1.0) }, // Blue tint for atmosphere
  },
  vertexShader: `
...
const atmosphereMaterial = new ShaderMaterial(atmosphereShader);
